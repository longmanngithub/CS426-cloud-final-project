...
@section('title', 'Post Event - Organizer Dashboard')

@section('content')
    <section class="bg-gradient-to-br from-[#1a1a2e] via-[#16213e] to-[#0f3460] text-white py-12 text-center">
        <h1 class="text-3xl md:text-4xl font-bold mb-2"><i class="fas fa-plus-circle mr-2"></i> Post Event</h1>
        <p class="text-white/80">Create a new event and reach your audience</p>
    </section>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-6 md:p-8">
                <div class="mb-8 pb-4 border-b border-gray-100 dark:border-gray-700">
                    <h2 class="text-xl font-bold flex items-center gap-2 dark:text-white">
                        <i class="fas fa-edit text-blue-600"></i> Event Details
                    </h2>
                </div>
                ...
                <form method="POST" action="/events" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    @csrf
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative w-full overflow-hidden">
                                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl flex flex-col items-center justify-center h-[400px] bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:hover:bg-gray-700 hover:border-blue-500 transition-all cursor-pointer relative overflow-hidden group" id="posterContainer">
                                    <img id="imagePreview" src="#" alt="Preview" class="hidden w-full h-full object-contain bg-gray-100 dark:bg-gray-700">
                                    <div class="text-center p-6" id="uploadPlaceholder">
                                        ...
                                        <p class="text-gray-600 dark:text-gray-400 text-sm"><strong>Click to upload</strong><br>or drag and drop</p>
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-5">
                        <div class="space-y-2">
                            ...
                            <input type="text" id="title" name="title" placeholder="Enter event title" required class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all dark:placeholder-gray-500">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2 min-w-0">
                                ...
                                <input type="text" id="start_time" name="start_time" required placeholder="Select Start Time" onfocus="(this.type='time')" onblur="(this.value ? this.type='time' : this.type='text')" class="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-3 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-w-0 box-border dark:placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2 min-w-0">
                                ...
                                <input type="text" id="end_date" name="end_date" placeholder="Select End Date" onfocus="(this.type='date')" onblur="(this.value ? this.type='date' : this.type='text')" class="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-3 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-w-0 box-border dark:placeholder-gray-500">
                            </div>
                            <div class="space-y-2 min-w-0">
                                <label for="end_time" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">End Time (Optional)</label>
                                <input type="text" id="end_time" name="end_time" placeholder="Select End Time" onfocus="(this.type='time')" onblur="(this.value ? this.type='time' : this.type='text')" class="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-3 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-w-0 box-border dark:placeholder-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" id="location" name="location" placeholder="Event location or venue" required class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all dark:placeholder-gray-500">
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div class="space-y-2 min-w-0">
                                ...
                                <input type="number" id="price" name="price" placeholder="Enter 0 for free events" min="0" step="0.01" required class="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-3 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-w-0 box-border dark:placeholder-gray-500">
                            </div>
                            <div class="space-y-2 min-w-0">
                                <label for="link" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Registration Link (Optional)</label>
                                <input type="text" id="link" name="link" placeholder="e.g. Google Form link" class="appearance-none block w-full bg-white dark:bg-gray-700 text-gray-700 dark:text-white border border-gray-200 dark:border-gray-600 rounded-lg px-4 py-3 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-w-0 box-border dark:placeholder-gray-500">
                            </div>
                        </div>

                        <div class="space-y-2">
                            <label for="description" class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Description</label>
                            <textarea id="description" name="description" placeholder="Describe your event..." class="w-full px-4 py-3 rounded-lg border border-gray-200 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:outline-none focus:border-blue-500 focus:ring-4 focus:ring-blue-500/10 transition-all min-h-[120px] resize-y dark:placeholder-gray-500"></textarea>
                        </div>

                        <button type="submit" class="w-full bg-blue-600 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-700 transition-colors flex items-center justify-center gap-2 mt-2 cursor-pointer">
    ...
    <script>
        ...
        document.getElementById('picture_url').addEventListener('input', function(event) {
            ...
            if (url) {
                ...
                // Reset file input if URL is entered
